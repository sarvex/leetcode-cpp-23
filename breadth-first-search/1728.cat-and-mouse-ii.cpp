...
public:
  ...
  std::vector<std::vector<int>> findAllAdjacents(std::vector<std::string> &grid, int mx, int my, int cx, int cy, int t) {
    int m = grid.size();
    int n = grid[0].size();
  ...
  bool allAdjacentsWin(std::vector<std::string> &grid, int mx, int my, int cx, int cy, int t) {
    int m = grid.size();
    int n = grid[0].size();
    auto dir = std::vector<std::pair<int, int>>({{1, 0}, {-1, 0}, {0, 1}, {0, -1}});
